  ...
  return (
    <div className="w-full max-w-6xl mx-auto text-center">
      <div className="space-y-6">
        ...
        {entries.length === 0 ? (
          <div className="bg-blue-600 p-6 rounded-3xl shadow-xl shadow-blue-950/20">
            <p className="text-blue-200">Aucun message client disponible pour le moment.</p>
          </div>
        ) : (
          <div className="space-y-4">
            {entries.map((entry) => (
              <div key={entry.id} className="bg-blue-600 p-6 rounded-3xl shadow-xl shadow-blue-950/20">
                <p>{entry.subject}</p>
              </div>
            ))}
          </div>
