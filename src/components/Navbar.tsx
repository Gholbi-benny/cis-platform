  ...
  return (
    <header className="border-b border-slate-200 bg-white/95 backdrop-blur-xl sticky top-0 z-20 shadow-lg dark:border-slate-700 dark:bg-slate-900/95">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-6 py-4">
        <div>
          <div className="text-slate-900 dark:text-white text-lg font-bold tracking-tight">CIS Platform</div>
          <div className="text-xs text-slate-500 dark:text-slate-400 uppercase tracking-wider">Gestion collaborative</div>
        </div>
            ...
            <>
              ...
              <div className="relative">
                <button onClick={openNotifications} className="relative mr-3">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-slate-600 dark:text-slate-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                {showNotifs && (
                  <div className="absolute right-0 mt-2 w-80 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-lg shadow-lg p-3 z-50">
                    <div className="text-sm font-semibold mb-2 text-slate-900 dark:text-white">Notifications</div>
              ...
              <button
                onClick={logout}
                className="rounded-lg bg-slate-800 hover:bg-slate-700 dark:bg-gradient-to-r dark:from-slate-700 dark:to-slate-800 dark:hover:from-slate-600 dark:hover:to-slate-700 px-4 py-2 text-sm font-semibold text-white transition shadow-md hover:shadow-lg"
              >
                Déconnexion
              </button>
            </>
